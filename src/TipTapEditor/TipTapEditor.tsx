...
const TipTapEditor = ({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: `focus:outline-none p-2 sm:p-4 overflow-y-auto text-white bg-[#1C2936] text-white`,
        style: height
          ? `height: ${height}; min-height: ${height}; max-height: ${height}; text-white word-wrap: break-word; overflow-wrap: break-word; white-space: pre-wrap;`
  ...
  useEffect(() => {
    if (editor) {
      const updateClasses = () => {
        ...
        content.className = `bg-[#1C2936] text-white p-2 sm:p-4 md:p-6 sm:p-4 min-h-[200px] sm:min-h-[300px] md:min-h-[400px] lg:min-h-[500px] xl:min-h-[600px] max-h-[250px] sm:max-h-[350px] md:max-h-[450px] lg:max-h-[550px] xl:max-h-[650px]  overflow-y-auto focus:outline-none`;
      };
      updateClasses();
    }
  }, [editor]);
  ...
  return (
    <>
      ...
      <div className={`transition-color duration-200 bg-[#1C2936] text-gray-900 `}>
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  className={`px-2 sm:px-4 py-1 sm:py-2 cursor-pointer rounded text-sm sm:text-base shrink-0 ${editor?.isActive("underline")
                    ? "bg-[#1C2936] text-white"
                    : "hover:bg-gray-200"
                    }`}
                >
                ...
                <button
                  ...
                  className={`px-2 sm:px-3 py-1 sm:py-2 cursor-pointer rounded shrink-0 ${editor?.isActive("bulletList")
                    ? "bg-[#1C2936] text-white"
                    : "hover:bg-gray-200"
                    }`}
                >
                ...
                <button
                  ...
                  className={`px-2 sm:px-3 py-1 sm:py-2 cursor-pointer rounded shrink-0 ${editor?.isActive("orderedList")
                    ? "bg-[#1C2936] text-white"
                    : "hover:bg-gray-200"
                    }`}
                >
              ...
              {mounted ? (
                <EditorContent
                  editor={editor}
                  className="bg-gray-50 border text-white border-gray-200 rounded-lg overflow-x-hidden"
                  style={
                    height
                      ? {
                        height,

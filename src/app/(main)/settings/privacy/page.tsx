    ...
    <div className="text-white p-4 sm:p-6 pb-12">
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl md:text-3xl font-bold text-white">Change Privacy Policy</h1>
          <p className="text-gray-400 text-sm md:text-base">Write and Update Privacy Policy</p>
        </div>

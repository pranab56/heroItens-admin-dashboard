    ...
    <div className="text-white">
      ...
      <form onSubmit={handleSubmit} className="bg-[#1a2332] rounded-lg p-6">
        ...
        <div className="mb-6 w-full">
          ...
          >
            <SelectTrigger className={` w-full border-[#2a3744] text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 ${errors.categoryType ? 'border-red-500' : ''
              }`}>
            ...
            <div className="relative rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="p-1 hover:bg-[#2a3744] rounded-full transition-colors"
                >
        ...
        <div className="flex justify-end gap-4">
          <Button
            ...
            variant="outline"
            className="bg-[#FF48481F] border-[#2a3744] text-red-500 hover:bg-[#2a3744] hover:text-white px-6"
          >
            Cancel
          </Button>
          <Button
